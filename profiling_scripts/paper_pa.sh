...
python3 nsys_export_csv.py  \
 ...
 --gpu H100 --outdir ./csv_H100  --prefix pa

 
python3 nsys_plot_figures.py \
    --occupancy ./csv_H100/pa_occupancy.csv \
    --gpu-util  ./csv_H100/pa_gpu_util.csv \
    --memcpy    ./csv_H100/pa_memcpy.csv \
    --outdir    ./csv_H100 --prefix pa 
