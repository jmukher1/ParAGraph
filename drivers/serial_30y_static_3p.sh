...
do
    ...
    OUTPUT_FILE="./output/cpu-serial-static-output-3p-${NUM_CYCLES}y-${GROWTH_PERCENT}p.edgelist"
    OUTPUT_LOG="./output/cpu-serial-static-output-3p-${NUM_CYCLES}y-${GROWTH_PERCENT}p-${NUM_THREADS}t.log"
    OUTPUT_AUX="./output/cpu-serial-static-output-3p-${NUM_CYCLES}y-${GROWTH_PERCENT}p.aux"
    OUT_FILE="./output/cpu-serial-static-output-3p-${NUM_CYCLES}y-${GROWTH_PERCENT}p-${NUM_THREADS}t.out"
