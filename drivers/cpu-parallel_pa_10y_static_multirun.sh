...
do
    ...
    OUTPUT_FILE="./output/cpu-parallel-run-${RUN}-${MODEL}-static-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.edgelist"
    OUTPUT_LOG="./output/cpu-parallel-run-${RUN}-${MODEL}-static-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p-${NUM_THREADS}t.log"
    OUTPUT_AUX="./output/cpu-parallel-run-${RUN}-${MODEL}-static-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.aux"
    OUT_FILE="./output/cpu-parallel-run-${RUN}-${MODEL}-static-${NUM_CYCLES}y-${GROWTH_PERCENT}p-${NUM_THREADS}t-abm.out"
