...
do
    ...
    do
        ...
        OUTPUT_FILE="./output/gpu-parallel-${dataset}-static-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.edgelist"
        OUTPUT_LOG="./output/gpu-parallel-${dataset}-static-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p-${NUM_THREADS}t.log"
        OUTPUT_AUX="./output/gpu-parallel-${dataset}-static-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.aux"
        OUT_FILE="./output/gpu-parallel-${dataset}-static-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p-${NUM_THREADS}t.out"
