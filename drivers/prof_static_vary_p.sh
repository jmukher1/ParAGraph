...
#    ncu -o report_name \
    NCU_METRICS="launch__registers_per_thread,launch__shared_mem_per_block_static,launch__shared_mem_per_block_dynamic,launch__occupancy_theoretical,launch__waves_per_multiprocessor,launch__block_size,launch__grid_size,launch__thread_count"
    ...
    --log-level ${LOG_LEVEL} \
    > "profile/ncu_launch_${GROWTH_LABEL}p.csv"
