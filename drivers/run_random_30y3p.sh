...
OUTPUT_FILE="./output/cpu-random-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.edgelist"
CMDLINE_OUTPUT="./output/cpu-random-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.out"
OUTPUT_LOG="./output/cpu-random-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.log"
OUTPUT_AUX="./output/cpu-random-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.aux"
