...
OUTPUT_FILE="./output/gpu-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.edgelist"
OUTPUT_LOG="./output/gpu-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.log"
OUTPUT_AUX="./output/gpu-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.aux"
