...
OUTPUT_FILE="./output/cpu-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.edgelist"
OUTPUT_LOG="./output/cpu-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.log"
OUTPUT_AUX="./output/cpu-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.aux"
