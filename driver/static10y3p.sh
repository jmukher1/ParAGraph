...
OUTPUT_FILE="./output/gpu-static-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.edgelist"
OUTPUT_LOG="./output/gpu-static-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.log"
OUTPUT_AUX="./output/gpu-static-output-${NUM_CYCLES}y-${GROWTH_PERCENT}p.aux"
CMDLINEOUT_FILE="./output/gpu-static-${NUM_CYCLES}y-${GROWTH_PERCENT}p-abm.out"
